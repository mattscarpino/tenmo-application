...
public interface TransactionDao {
    ...
    boolean sendTransaction(long sender_id, int receiver_id, double transfer_amount);

    boolean createRequest(int sender_id, long receiver_id, double transfer_amount);
