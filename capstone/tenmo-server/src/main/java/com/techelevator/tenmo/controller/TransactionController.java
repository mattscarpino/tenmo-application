...
//    }
    ...
    @PreAuthorize("hasRole('USER')")
    @PostMapping("/send")
    public void initiateTransaction(Principal principal, @RequestParam int receiver_id, @RequestParam double transfer_amount){
...
//    }
    ...
    @PreAuthorize("hasRole('USER')")
    @PostMapping("/request")
    public void initiateRequest(Principal principal, @RequestParam int sender_id, @RequestParam double transfer_amount, @PathVariable int user_id){
    ...
    @PreAuthorize("hasRole('USER')")
    @GetMapping("/find")
    public String getTransactionById(@RequestParam int transaction_id,Principal principal){
